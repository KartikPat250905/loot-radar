...
actual class UserStatsRepository actual constructor(private val authRepository: AuthRepository, private val settings: ObservableSettings) {
    ...
    actual suspend fun syncClaimedValue() = withContext(Dispatchers.IO) {
        try {
    ...
    actual suspend fun addToClaimedValue(gameId: Long, worth: Float) = withContext(Dispatchers.IO) {
